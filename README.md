...
This is declaration about the ownership of the code base.
I want to tell you that the code has used the starter-code files of the udacity JWDND projects repository and then it it built completely by me. I have not used any piece of code from anywhere on the internet/books. If still you find some plagarism, then please look after the file, if it's being used from the starter code provided, if not then please check if the file has repository appended to it. Because, utlimately, I can't change the SQL queries, they are gonna be same. I have put efforts in coding this project 2nd time again from scratch, so please think and see the files atleast, if you are going to mark this as plagarismed code. I hope you like the project. I tried to write everything considering the code should not break and made it robust to the extent I was able to. I hope you like my project.
